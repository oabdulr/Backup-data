...
function getNow() {
    ...
    const time = hours + ":" + minutes + ":" + seconds + " <span class='text-4xl'>" + ampm + "</span>";
    this.timestamp = time;
	...
	document.getElementById("sunriseT").innerHTML = times["sunrise"]; // Fixed typo
